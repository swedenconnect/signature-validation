...
import org.etsi.uri.x19102.v12.TypedDataType;
import org.etsi.uri.x19102.v12.ValidationStatusType;
...
public class DefalutPDFSigValReportGenerator extends AbstractSigValReportGenerator<ExtendedPdfSigValResult> {
   ...
   */
  @Override protected DigestAlgAndValueType getSignatureDtbsDigestAndValue(ExtendedPdfSigValResult sigValResult, String hashAlgoId) throws IOException {
